                        ...
                        <form onSubmit={postData}>
                            <div className="row">
                                ...
                                <div className="col-12 mb-3">
                                    ...
                                    <textarea type="text" name="shortDescription" value={data.shortDescription} onChange={getInputData} placeholder='Description' rows={3} className={`${show & errorMessage.shortDescription ? 'border-danger' : ''} form-control`}></textarea>
                                    {show && errorMessage.shortDescription ? <p className='text-danger'>{errorMessage.shortDescription}</p> : null}
                                </div>
                                <div className="col-lg-6 mb-3">
                                    <label>Icon*</label>
                                    <input type="text" name="icon" value={data.icon} onChange={getInputData} placeholder='e.g <i class="fab-fa-list"></i>' className={`${show & errorMessage.icon ? 'border-danger' : ''} form-control`} />
